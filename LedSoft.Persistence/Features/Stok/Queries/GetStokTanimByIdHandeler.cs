...
{
    public class GetStokTanimByIdRequest:IRequest<ServiceResponse<StokListDTO>>
    {
        public int StokId { get; set; }
    }
    public class GetStokTanimByIdHandeler : IRequestHandler<GetStokTanimByIdRequest, ServiceResponse<StokListDTO>>
    {
        ...
        public async Task<ServiceResponse<StokListDTO>> Handle(GetStokTanimByIdRequest request, CancellationToken cancellationToken)
        {
